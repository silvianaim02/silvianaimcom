...
const TechStack = () => {
  return (
    <div className='relative flex flex-col items-center overflow-hidden py-20 dark:bg-gray-800 md:py-40'>
          ...
          <div className='flex flex-wrap justify-center gap-6'>
            <div className='group rounded-xl border border-gray-200 bg-white bg-opacity-5 px-4 py-2 hover:bg-opacity-10 dark:border-gray-600'>
              <Image
                ...
                className='h-16 w-16 rounded-full contrast-100 transition group-hover:contrast-0'
                loading='lazy'
                alt='logo airbnb'
                height={64}
                width={64}
